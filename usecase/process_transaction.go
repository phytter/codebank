...
import (
	"github.com/phytter/codebank/domain"
	"github.com/phytter/codebank/dto"
	"time"
)
...
func (u UseCaseTransaction) ProcessTransaction(transactionDto dto.Transaction) (domain.Transaction, error) {
	crediCard := u.hydrateCreditCard(transactionDto)
...
func (u UseCaseTransaction) hydrateCreditCard(transactionDto dto.Transaction) {
